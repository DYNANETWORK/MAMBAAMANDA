...
from MAMBAAMANDA.modules import ALL_MODULES
from MAMBAAMANDA.modules.helper_funcs.alternate import typing_action
from MAMBAAMANDA.modules.helper_funcs.chat_status import is_user_admin
from MAMBAAMANDA.modules.helper_funcs.misc import paginate_modules
from MAMBAAMANDA.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm MAMBA
I'm a Powerful group manager bot With Cool Modules. Made by [ɮʟǟƈӄ ʍǟʍɮǟ• 🇱🇰](https://t.me/BLACKMAMBA_OFFICIAL)
...
buttons = [
    [
        InlineKeyboardButton(
            text="📢Updates Channel", url="https://t.me/MAMBA_NETWORK"
        ),
        InlineKeyboardButton(
            text="👥 Support Group", url="https://t.me/MAMBA_X_SUPPORT"
        ),
    ],
    [
        InlineKeyboardButton(
            text="📜Source", url="https://github.com/SUKHPAL443/MAMBAAMANDA"
        ),
        InlineKeyboardButton(
            text="❔ Help", url="http://t.me/THEMAMBAGBOT?start=help"
        ),
    ],
    [
        InlineKeyboardButton(
            text="➕ Add Amanda to your group ➕",
            url="t.me/THEMAMBAGBOT?startgroup=true",
        ),
    ],
]

Amanda_IMG = "https://telegra.ph/file/a8a793a8716bdcc923fd3.png"

HELP_STRINGS = f"""
*Main Commands :* [👩](https://telegra.ph/file/a8a793a8716bdcc923fd3.png)
...
Support them  [ɮʟǟƈӄ ʍǟʍɮǟ](https://t.me/BLACKMAMBA_OFFICIAL)"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("MAMBAAMANDA.modules." + module_name)
...
def Amanda_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"* Hi There  The name's {dispatcher.bot.first_name} \n\nAs  You I'm a next generational group management bot developed by MAMBA Updates.* "
            f"\n\n Join [MAMBA](https://t.me/MAMBA_X_SUPPORT) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [MAMBA](https://t.me/MAMBA_X_SUPPORT).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is the redisigned version of Raya for the best performance.*"
            f"\n\nBased on [MAMBA's Brother](https://t.me/MAMBA_X_SUPPORT)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by BLACKMAMBA_OFFICIAL"
